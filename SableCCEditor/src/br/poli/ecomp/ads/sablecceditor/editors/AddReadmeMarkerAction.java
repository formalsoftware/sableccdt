...
public class AddReadmeMarkerAction extends Action {
    ...
    public void run() {
        ...
        try {
            ...
            Bundle bundle = SableCCPlugin.getDefault().getBundle();
            Platform.getLog(bundle).log(x.getStatus());

            Shell shell = textEditor.getSite().getShell();
            String title = "Add_readme_marker_error_title"; //$NON-NLS-1$
            String msg = "Add_readme_marker_error_message"; //$NON-NLS-1$
